...
```{r hh_point_map, fig.width=12, fig.height=6, message=F, warning=F}
require(sp)
require(methods)
...
```{r mst_networkplan_map, fig.width=12, fig.height=6, message=F, warning=F}
...
```{r decomposed_map, fig.width=12, fig.height=12, message=F, warning=F}
